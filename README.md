...
![Experiment results](plot-experiment-2b-error.png) ![Experiment results](plot-experiment-2b-time.png)
...
![Experiment results](plot-experiment-4d-error.png) ![Experiment results](plot-experiment-4d-time.png)
