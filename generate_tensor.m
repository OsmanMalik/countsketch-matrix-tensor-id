...
% GENERATE_TENSOR Generate tensor with known structure
%
...
%
%   X = GENERATE_TENSOR(___, 'density', d) returns the same tensor as 
%   above, but each random column of each factor matrix is a sparse vector
%   with density d. 
%   
% REFERENCES:
%
